...
(define exe-1 "C:\\Users\\bnetn\\AppData\\Local\\Programs\\Python\\Python39\\Python.exe")
(define args-1 "PLAYER_INTERFACE.py")
(define exe-2 "C:\\Users\\bnetn\\AppData\\Local\\Programs\\Python\\Python39\\Python.exe")
  ...
  (instantiate menu-item%
    ...
    (callback
     (lambda (menu-item event)
       ...
       (send player-1-args-text-field set-value args-1)
       (send player-2-exe-text-field set-value exe-2)
       (send player-2-args-text-field set-value args-2)
       (send dialog show #t)))))
  ...
  (instantiate button%
    ...
    (callback
     (lambda (button event)
       ...
       (set! args-1 (send player-1-args-text-field get-value))
       (set! exe-2 (send player-2-exe-text-field get-value))
       (set! args-2 (send player-2-args-text-field get-value))
